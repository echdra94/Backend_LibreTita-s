...
btnEnviar.addEventListener("click", function (event) {
    ...
    .then(response => {
        if (!response.ok) throw new Error("Error al guardar producto en la API");
        return response.json();
    })
    .then(data => {
        alertValidacionesTexto.innerHTML = "<strong class='text-success'>¡Producto registrado en la base de datos con éxito!</strong>";
